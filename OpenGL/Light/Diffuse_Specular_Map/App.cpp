...
int main()
{
	...
	unsigned int CubeSpecularMap = Texture::loadTexture("Texture/pics/containerSpecularMap2.png");
	unsigned int CubeEmissionMap = Texture::loadTexture("Texture/pics/containerEmission.jpg");
	CubeShader.useShaderProgram();

	CubeShader.useUniformInt("material.Diffuse", 0);
	CubeShader.useUniformInt("material.Specular", 1);
	CubeShader.useUniformInt("material.Emission", 2);
	...
	CubeShader.useUniformVec3("light.Ambient", 0.2f * LightColor);
	CubeShader.useUniformVec3("light.Diffuse", 0.5f * LightColor);
	...
	glDeleteTextures(1, &CubeEmissionMap);
