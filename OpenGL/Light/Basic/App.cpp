...
int main()
{
	...
	Shader CubeShader("Shader/CubeVertexShader.vs", "Shader/CubeFragmentShader.fs");
	...
	CubeShader.useUniformMat4("MatModel", glm::mat4(1.0f));

	glm::vec3 LightPos = glm::vec3(2.0f, 2.0f, -2.0f);
	glm::vec3 LightColor = glm::vec3(1.0f, 1.0f, 1.0f);
	glm::vec3 CubeColor = glm::vec3(1.0f, 0.5f, 0.31f);

	CubeShader.useUniformVec3("material.Ambient", glm::vec3(0.0f, 0.0f, 0.0f));
	CubeShader.useUniformVec3("material.Diffuse", glm::vec3(0.5f, 0.0f, 0.0f));
	CubeShader.useUniformVec3("material.Specular", glm::vec3(0.7f, 0.6f, 0.6f));
	CubeShader.useUniformFloat("material.Shininess", 32.0f);

	CubeShader.useUniformVec3("light.Ambient", LightColor);
	CubeShader.useUniformVec3("light.Diffuse", LightColor);
	CubeShader.useUniformVec3("light.Specular", LightColor);
	CubeShader.useUniformVec3("light.Position", LightPos);

	LightShader.useShaderProgram();
	glm::mat4 ModelMat = glm::mat4(1.0f);
	ModelMat = glm::translate(ModelMat, LightPos);
	ModelMat = glm::scale(ModelMat, glm::vec3(0.2f, 0.2f, 0.2f));
	LightShader.useUniformMat4("MatModel", ModelMat);
...
void processInput(GLFWwindow* window)
{
	...
	if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS)
		camera.processKeyboardInput(FORWORD, deltaTime);
	if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS)
		camera.processKeyboardInput(BACKWORD, deltaTime);
