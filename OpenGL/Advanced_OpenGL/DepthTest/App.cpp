...
int main()
{
	...
	Shader shader("ShaderCodes/DepthTest/DepthTest.vert","ShaderCodes/DepthTest/DepthTest.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		Mat4 ProjectionMat = glm::perspective(Math::Radians(camera.getFOV()), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
		shader.useUniformMat4("ViewMat", ViewMat);
		shader.useUniformMat4("ProjectionMat", ProjectionMat);
		// cubes
		glBindVertexArray(cubeVAO);
		glActiveTexture(GL_TEXTURE0);
		glBindTexture(GL_TEXTURE_2D, cubeTexture);
		ModelMat = Math::Translate(ModelMat, Vector3(-1.0f, 0.01f, -1.0f));
		shader.useUniformMat4("ModelMat", ModelMat);
		...
		shader.useUniformMat4("ModelMat", Mat4(1.0f));
