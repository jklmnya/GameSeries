...
int main()
{
	...
	Shader CubeShader("ShaderCodes/FaceCulling/Cube.vert", "ShaderCodes/FaceCulling/Cube.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		CubeShader.useUniformMat4("ViewMat", ViewMat);
		CubeShader.useUniformMat4("ProjectionMat", ProjectionMat);

		// Draw Cube
		glActiveTexture(GL_TEXTURE0);
		CubeShader.useUniformUInt("cube_texture", cubeTexture);
		glBindTexture(GL_TEXTURE_2D, cubeTexture);
		glBindVertexArray(cubeVAO);
		Mat4 ModelMat = Mat4(1.0f);
		ModelMat = Math::Translate(ModelMat, Vector3(-1.0f, 0.0f, -1.0f));
		CubeShader.useUniformMat4("ModelMat", ModelMat);
