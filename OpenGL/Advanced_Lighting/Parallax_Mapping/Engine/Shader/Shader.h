...
public:
	...
	inline void useMVP(const Mat4& ModelMat, const Mat4& ViewMat, const Mat4& ProjectionMat) {
		this->useUniformMat4("ModelMat", ModelMat);
		this->useUniformMat4("ViewMat", ViewMat);
		this->useUniformMat4("ProjectionMat", ProjectionMat);
	}
