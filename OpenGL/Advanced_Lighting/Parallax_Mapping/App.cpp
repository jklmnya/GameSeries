...
int main()
{
	...
	// Shader
	Shader BrickShader("ShaderCodes/Advanced_Lighting/Parallax_Mapping/ToyShaderPOM.vert", 
	 	"ShaderCodes/Advanced_Lighting/Parallax_Mapping/ToyShaderPOM.frag");

	// Texture
	unsigned int BaseColor = TextureUtil::TextureFromFile("Textures/pics/wood.png");
	unsigned int NormalMap = TextureUtil::TextureFromFile("Textures/pics/toy_box_normal.png");
	unsigned int HeightMap = TextureUtil::TextureFromFile("Textures/pics/toy_box_disp.png");

	BrickShader.useShaderProgram();
	BrickShader.useUniformInt("DiffuseMap", 0);
	BrickShader.useUniformInt("NormalMap", 1);
	BrickShader.useUniformInt("HeightMap", 2);
